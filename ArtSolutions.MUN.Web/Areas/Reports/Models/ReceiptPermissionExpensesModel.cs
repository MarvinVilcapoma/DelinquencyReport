...
{
    public class ReceiptPermissionExpensesModel : DataExportModel
    {
        ...
        public List<ReceiptPermissionExpensesModelList> ReceiptPermissionExpensesList { get; set; }
        ...
        #region Constructor
        public ReceiptPermissionExpensesModel()
        {
            this.AccountList = new List<SelectListItemViewModel>();
        }
        #endregion
    }
    public class ReceiptPermissionExpensesModelList
    {
        #region public properties
        ...
        public string FormattedEstimatedCost
        {
            get
            {
                return EstimatedCost.ToString("C");
            }
        }
        #endregion
    }
