...
{
    public class ControlOfPaymentsMadeInTheBank
    {
        #region public methods      
        public ControlOfPaymentsMadeInTheBankModel Get()
        {
        ...
        public ControlOfPaymentsMadeInTheBankModel Get(JQDTParams jqdtParams, DateTime startPeriod, string contractIds, string bankIds, string serviceIds)
        {
            ControlOfPaymentsMadeInTheBankModel model = new ControlOfPaymentsMadeInTheBankModel();
            if (jqdtParams != null)
        ...
        public ControlOfPaymentsMadeInTheBankModel GetByPaging(DateTime startPeriod, string contractIds, string bankIds, string serviceIds)
        {
            ...
            return new RestSharpHandler().RestRequest<ControlOfPaymentsMadeInTheBankModel>(APISelector.Municipality, true, "api/Report/ControlOfPaymentsMadeInTheBankGet", "GET", lstParameter);

        }
        public ControlOfPaymentsMadeInTheBankModel GetExportLayout(DateTime startPeriod, string contractIds, string bankIds, string serviceIds)
        {
        ...
        {
            return new ReportCompanyModel().Get(ArtSolutions.MUN.Web.Resources.Report.ControlofPaymentsmadeintheBank, ArtSolutions.MUN.Web.Resources.Report.DepartmentOfFinance, 8, null, null, null, null, null, null, false);
        }
        #endregion
    }
}