...
{
    public class BusinessLicenseBalanceModel : DataExportModel
    {
        ...
        public List<BusinessLicenseBalanceList> BusinessLicenseBalanceList { get; set; }
        ...
        #region Constructor
        public BusinessLicenseBalanceModel()
        {
    ...
    public class BusinessLicenseBalanceList
    {
        #region public properties
