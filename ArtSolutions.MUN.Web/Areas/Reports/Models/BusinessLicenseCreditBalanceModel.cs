...
{
    public class BusinessLicenseCreditBalanceModel : DataExportModel
    {
        ...
        public List<BusinessLicenseCreditBalanceList> BusinessLicenseCreditBalanceList { get; set; }
        ...
        #region Constructor
        public BusinessLicenseCreditBalanceModel()
        {
    ...
    public class BusinessLicenseCreditBalanceList
    {
        #region public properties
        ...
        public string FormattedCreditBalance
        {
            get
            {
                return CreditBalance.ToString("C");
            }
        }
