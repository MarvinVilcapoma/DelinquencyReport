...
window.portNumber = null; 
window.olapClientPortNumber = null;
window.isIISInstalled= null;
...
(function ($, ej, undefined) {
	...
	if (window.isIISInstalled){
		window.baseurl="/sfejservicesjssamplebrowser/";
	}
	else{
		window.baseurl="http://localhost:"+portNumber+"/";
	}
