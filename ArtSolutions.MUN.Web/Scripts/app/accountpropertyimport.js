...
$(document).ready(function () {
    $("#frmImportAccountProperty").steps({
        bodyTag: "fieldset",
        ...
        onStepChanging: function (event, currentIndex, newIndex) {
            ...
            if (newIndex === 1) {
                ...
                $.ajax({
                    async: false,
                    url: ROOTPath + '/AccountProperty/UploadFile',
                    data: formdata,
                    contentType: false,
                    processData: false,
                    type: 'POST',
            ...
            //STEP #2 Mapping
                ...
                $.ajax({
                    async: false,
                    url: ROOTPath + '/AccountProperty/ColumnMapping',
                    data: formdata,
                    contentType: false,
                    processData: false,
                    type: 'POST',
            ...
            //STEP #3 Validation
                ...
                $.ajax({
                    async: false,
                    url: ROOTPath + '/AccountProperty/ImportValidation',
                    data: formdata,
                    contentType: false,
                    processData: false,
                    type: 'POST',
        ...
        onFinished: function (event, currentIndex) {
            ...
            $.ajax({
                //async: false,
                url: ROOTPath + '/AccountProperty/FinishImport',
                data: formdata,
                contentType: false,
                processData: false,
                type: 'POST',
                success: function (response) {
                    if (!response.status) {
                        ...
                        isValid = true;
                        window.location.href = ROOTPath + "/AccountProperty/List";
                    }
                }
            });
        }
