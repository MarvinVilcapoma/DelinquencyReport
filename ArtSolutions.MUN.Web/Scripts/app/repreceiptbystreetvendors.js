...
function InitializeDataTable(tableName) {
    ...
    $('#' + tableName).dataTable({
        ...
        "scrollCollapse": true,
        "ajax": {
            "url": ROOTPath + "/Reports/Report/ReceiptByStreetVendors",
            "type": "POST",
            "data": function (data) {
        ...
        "columns": [
            ...
            {
                name: "AccountDisplayName", title: name, "data": "AccountDisplayName", className: "col-lg-3 text-description-field"
            },
            {
                name: "LateRenewal", title: laterenewal, "data": "FormattedLateRenewal", className: "col-lg-2 text-right"
            },
            {
                name: "PermitCost", title: permitcost, "data": "FormattedPermitCost", className: "col-lg-2 text-right"
            },
            {
...
function Print() {
    if (validateForm()) {
        $.ajax({
            type: "GET",
            url: ROOTPath + "/Reports/Report/PrintReceiptByStreetVendors",
            data: {
