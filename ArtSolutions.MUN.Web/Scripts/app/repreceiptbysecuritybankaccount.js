...
function InitializeDataTable(tableName) {
    ...
    var table = $('#' + tableName).dataTable({
        ...
        "scrollCollapse": true,
        "ajax": {
            "url": ROOTPath + "/Reports/Report/ReceiptBySecurityBankAccount",
            "type": "POST",
            "data": function (data) {
...
function createChild(idx, d) {
    $.post(ROOTPath + "/Reports/Report/GetReceiptBySecurityBankAccountHtml", { "DataListJSON": JSON.stringify(d) }, function (response) {
...
function Print() {
    if (validateForm()) {
        $.ajax({
            type: "GET",
            async: false,
            url: ROOTPath + "/Reports/Report/PrintReceiptBySecurityBankAccount",
            data: {
