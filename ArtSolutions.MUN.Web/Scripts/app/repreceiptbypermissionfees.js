...
function InitializeDataTable(tableName) {
    ...
    $('#' + tableName).dataTable({
        ...
        "scrollCollapse": true,
        "ajax": {
            "url": ROOTPath + "/Reports/Report/ReceiptByPermissionFees",
            "type": "POST",
            "data": function (data) {
        ...
        "columns": [
            ...
            {
                name: "TarrifType", title: tariffType, "data": "TypeName", className: "col-lg-4"
            },
            {
...
function Print() {
    if (validateForm()) {
        $.ajax({
            type: "GET",
            url: ROOTPath + "/Reports/Report/PrintReceiptByPermissionFees",
            data: {
