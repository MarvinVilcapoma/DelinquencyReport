    ...
    $('#DatatableList').dataTable({
        ...
        "columns": [
            ...
            },
            {
                ...
                "data": function (row) {
                    var str = "";
                    str = '<a href=' + ROOTPath + "/Collections/DebitNote/View?ID=" + row.ID + '&IsDH=' + row.IsDebitHistory+' class="btn btn-white btn-sm text-right"><i class="fa fa-folder"></i> ' + view + ' </a>';
                    return str;
                }
            }
        ],
