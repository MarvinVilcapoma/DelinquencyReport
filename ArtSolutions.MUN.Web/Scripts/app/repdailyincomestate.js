...
function InitializeData() {
    $.ajax({
        type: "POST",
        url: ROOTPath + "/Reports/Report/CollectionDailyIncomeState",
        data: {
        ...
        success: function (response) {
            if (response.status) {
                hideLoading();
                $("#divDailyIncomeState").html("").html(response.data);
                InitializeDataTable();
                rowCount = pageSize;
            }
            else {
...
function loadDailyIncomeState(element) {
    ...
    $.ajax({
        ...
        success: function (response) {
            $(response.data).insertBefore("#tbodyDailyIncomeState");
            ...
            if (rowCount < $("#TotalRecord").val()) {
                $("#tbodyDailyIncomeState").show();
            }
            else {
                $("#tbodyDailyIncomeState").hide();
            }
        }
    });
}
function Print() {
        ...
        $.ajax({
            type: "GET",
            url: ROOTPath + "/Reports/Report/PrintDailyIncomeState",
